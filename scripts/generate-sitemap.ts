...
const staticPages: PageEntry[] = [
  ...
  { path: '/compare/zoho-invoice-alternatives', priority: 0.7, changefreq: 'monthly' },
  { path: '/compare/best-invoicing-software-for-consultants', priority: 0.75, changefreq: 'monthly' },
  { path: '/compare/best-invoicing-software-for-contractors', priority: 0.75, changefreq: 'monthly' },
  { path: '/compare/best-invoicing-software-for-small-business', priority: 0.8, changefreq: 'monthly' },
  { path: '/compare/free-invoice-generator-vs-paid', priority: 0.75, changefreq: 'monthly' },
