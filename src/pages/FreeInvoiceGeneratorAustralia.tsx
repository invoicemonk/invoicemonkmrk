...
const australiaFAQs = [
  {
    question: 'Is this a free alternative to atoinvoice.com?',
    answer: 'Yes. Invoicemonk\'s free invoice generator works just like atoinvoice.com — create unlimited ATO-compliant tax invoices with ABN, GST, and BAS-ready formatting. No signup or credit card required.',
  },
  {
    question: 'Does this invoice generator include GST fields?',
    answer: 'Yes. You can add GST (10%) to individual line items or apply it across the entire invoice. The generator automatically calculates GST amounts and displays the total including and excluding GST.',
  },
  {
    question: 'Is the generated invoice ATO compliant?',
    answer: 'The generator produces tax invoices that include all ATO-required fields: the words "tax invoice," your ABN, date of issue, item descriptions, GST amounts, and the total price including GST — meeting requirements for both standard and detailed tax invoices.',
  },
  {
    question: 'Can I add my ABN to the invoice?',
...
const howToSteps = [
  { name: 'Enter your ABN and business details', text: 'Add your Australian Business Number, business name, and contact details in the "From" section. This information appears on every tax invoice.' },
  { name: 'Add your client\'s details', text: 'Enter your client\'s name, ABN (for invoices over $1,000), and address in the "Bill To" section.' },
  { name: 'Add GST-inclusive line items', text: 'List your products or services with quantities, rates, and GST. The calculator automatically handles the 10% GST computation.' },
  { name: 'Download your ATO-compliant PDF', text: 'Preview your tax invoice, then download it as a professional PDF ready to send to your client and keep for BAS reporting.' },
];
...
const FreeInvoiceGeneratorAustralia = () => {
  const { locale } = useLocale();
  const seo = pageSEO['/free-invoice-generator-australia'];
  ...
  return (
    <Layout>
      <FAQSchema items={australiaFAQs} />
      <BreadcrumbSchema items={[
        { name: 'Home', url: '/' },
        { name: 'Free Invoice Generator', url: '/free-invoice-generator' },
        { name: 'Australia', url: '/free-invoice-generator-australia' },
      ]} />
      <HowToSchema
        name="How to Create an ATO-Compliant Tax Invoice"
        description="Create a free, ATO-compliant tax invoice with ABN, GST, and BAS-ready formatting in under 5 minutes."
        steps={howToSteps}
        totalTime="PT5M"
      ...
      />
      <SEOHead
        title={seo?.getTitle(locale) || 'Free Invoice Generator Australia — ATO-Compliant | No Signup | Invoicemonk'}
        description={seo?.getDescription(locale) || 'Create ATO-compliant tax invoices with ABN, GST, and BAS-ready formatting. Free, no signup required. The best atoinvoice alternative.'}
      />
      ...
      <section className="py-10 lg:py-14 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-1.5 text-xs font-medium text-primary bg-primary/10 rounded-full px-3 py-1 mb-4">
            ...
            Free &amp; ATO-Compliant — No Signup Required
          </div>
          <h1 className="text-heading-lg font-bold text-foreground mb-3">
            Free Invoice Generator for Australian Businesses
          </h1>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Create professional tax invoices with ABN, GST calculations, and BAS-ready formatting.
      ...
      <section className="py-16 lg:py-24 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <h2 className="text-heading-lg font-bold text-foreground text-center mb-10">
            How to Create an ATO-Compliant Invoice
          </h2>
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-heading-lg font-bold text-foreground text-center mb-12">
            Built for Australian Tax Invoices
          </h2>
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <ul className="space-y-3">
            <li><Link to="/blog/ato-invoice-requirements-australian-compliance" className="text-primary hover:underline">ATO Invoice Requirements: Australian Compliance Guide</Link></li>
          ...
          <Card className="max-w-3xl mx-auto bg-primary">
            <CardContent className="p-8 lg:p-12 text-center">
              ...
              <p className="text-white/90 mb-6 max-w-xl mx-auto">
                Automate recurring invoices, track payments, manage GST reporting, and get paid faster with Invoicemonk's full platform — built for Australian businesses.
              </p>
...
export default FreeInvoiceGeneratorAustralia;
