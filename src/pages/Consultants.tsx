...
const benefitIcons = [Briefcase, Globe, BarChart3, Shield];
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link to="/use-cases/retainer-billing" className="text-primary hover:underline">{t('relatedLinks.retainer')}</Link>
