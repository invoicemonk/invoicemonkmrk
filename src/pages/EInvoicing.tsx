...
const pillarFaqs = [
  {
    ...
    answer:
      'An e-invoicing platform issues invoices as structured data (XML or JSON) and exchanges them with tax authorities or trading partners over a defined transport (direct API, Peppol Access Point, or national portal). Invoicemonk is an e-invoicing platform live in 18 mandates across 5 regions.',
  },
  {
