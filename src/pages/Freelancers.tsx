...
const faqs = [
  ...
  { question: 'Can I add my logo and branding to invoices?', answer: 'Yes. Upload your logo, choose brand colors, and create professional invoices that reflect your personal brand. Consistent branding across all client communications helps build trust and makes your freelance business look established.' },
