...
const faqs = [
  ...
  { question: 'Can I use free invoicing software as a freelancer?', answer: 'You can — Wave and Zoho Invoice offer free tiers that cover basic invoicing. Invoicemonk has a Free plan (3 invoices/month, 1 user), with unlimited invoicing from $15/month on the Pro plan, but it adds multi-currency, country-specific compliance, automated reminders, and a full audit trail that free tools typically lack.' },
];
...
export default function BestForFreelancers() {
  return (
    <Layout>
      ...
      <ProsConsSection
        tools={compareProsCons['best-invoicing-software-freelancers'].tools}
        title={compareProsCons['best-invoicing-software-freelancers'].title}
        background="muted"
      />
