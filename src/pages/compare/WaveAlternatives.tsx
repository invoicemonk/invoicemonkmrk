...
const faqs = [
  ...
  { question: 'How does Invoicemonk compare to Wave on price?', answer: 'Yes. Invoicemonk\'s free plan includes unlimited invoices, expense tracking, and basic accounting — similar to Wave. Unlike Wave, Invoicemonk also includes multi-currency support and global tax compliance on the Pro plan. Neither requires a credit card to start.' },
