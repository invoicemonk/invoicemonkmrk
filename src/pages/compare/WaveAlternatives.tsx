...
const faqs = [
  ...
  { question: "How does Invoicemonk compare to Wave on price?", answer: "Invoicemonk has a Free plan ($0/month, 3 invoices/month, 1 user). Pro starts at $15/month with unlimited invoices, multi-currency invoicing, and cross-border compliance built in — features Wave's free Starter tier does not offer." },
...
export default function WaveAlternatives() {
  return (
    <Layout>
      ...
      <ProsConsSection
        tools={compareProsCons['wave-alternatives'].tools}
        title={compareProsCons['wave-alternatives'].title}
        background="muted"
      />
