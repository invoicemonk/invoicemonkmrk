...
export default function BestFreeInvoicingSoftware() {
  return (
    <Layout>
      ...
      <ProsConsSection
        tools={compareProsCons['best-free-invoicing-software'].tools}
        title={compareProsCons['best-free-invoicing-software'].title}
        background="muted"
      />
