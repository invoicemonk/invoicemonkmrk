    ...
    <Layout>
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <ReviewedLine slug="best-invoicing-software-ghana" />
          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="https://app.invoicemonk.com/signup?utm_source=compare&utm_medium=cta&utm_campaign=compare_to_signup" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Free Invoice Generator Ghana</a>
      ...
      <ProsConsSection
        tools={compareProsCons['best-invoicing-software-ghana'].tools}
        title={compareProsCons['best-invoicing-software-ghana'].title}
        background="muted"
      />
      ...
      <MandateMatrixSection highlightSlug="gra-e-vat-ghana" />
