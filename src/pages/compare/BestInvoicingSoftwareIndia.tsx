...
const faqs = [
  ...
  { question: 'Is there free invoicing software for India?', answer: 'Yes. Invoicemonk offers a free plan with GST-compliant invoicing, GSTIN fields, HSN/SAC code support, and CGST/SGST/IGST calculations. Zoho Invoice also has a Pro plan but limits you to 5 customers.' },
];
