...
export default function BestInvoicingSoftware() {
  ...
  return (
    <Layout>
      ...
      <BreadcrumbSchema items={[{ name: 'Home', url: '/' }, { name: 'Compare', url: '/compare/best-invoicing-software' }, { name: 'Best Invoicing Software', url: '/compare/best-invoicing-software' }]} />
