    ...
    <Layout>
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <ReviewedLine slug="best-invoicing-software-malaysia" />
      ...
      <ProsConsSection
        tools={compareProsCons['best-invoicing-software-malaysia'].tools}
        title={compareProsCons['best-invoicing-software-malaysia'].title}
        background="muted"
      />
      ...
      <MandateMatrixSection highlightSlug="myinvois-malaysia" />
