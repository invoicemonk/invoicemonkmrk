...
export default function InvoicemonkEstimatesVsQuickbooks() {
  ...
  return (
    <Layout>
      ...
      <BreadcrumbSchema items={[{ name: 'Home', url: '/' }, { name: 'Compare', url: '/compare/best-invoicing-software' }, { name: 'Estimates vs QuickBooks', url: '/compare/invoicemonk-estimates-vs-quickbooks' }]} />
