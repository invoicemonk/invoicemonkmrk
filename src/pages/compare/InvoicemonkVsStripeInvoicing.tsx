...
export default function InvoicemonkVsStripeInvoicing() {
  const { t } = useTranslation('compareStripeInvoicing');
  ...
  return (
    <Layout>
      ...
      <BreadcrumbSchema items={[{ name: 'Home', url: '/' }, { name: 'Compare', url: '/compare/best-invoicing-software' }, { name: 'vs Stripe Invoicing', url: '/compare/invoicemonk-vs-stripe-invoicing' }]} />
      <ComparisonReviewSchema
        itemName="Invoicemonk"
        competitorName="Stripe Invoicing"
        positiveNotes={chooseInvoicemonk}
        negativeNotes={chooseCompetitor}
        url="/compare/invoicemonk-vs-stripe-invoicing"
      />

      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <h1 className="text-heading-xl font-bold text-foreground text-center mb-4">{t('hero.title')}</h1>
          <ReviewedLine slug="invoicemonk-vs-stripe-invoicing" />
          ...
          <ComparisonTable competitorName="Stripe Invoicing" features={features} />
          <div className="mt-16">
      ...
      <ProsConsSection
        tools={compareProsCons['invoicemonk-vs-stripe-invoicing'].tools}
        title={compareProsCons['invoicemonk-vs-stripe-invoicing'].title}
        background="muted"
      />
