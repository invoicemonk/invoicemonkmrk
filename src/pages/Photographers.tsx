...
const faqs = [
  ...
  { question: 'Can I add my photography branding to invoices?', answer: 'Yes. Upload your logo and create a professional look that matches your photography style. Consistent branding across your portfolio, website, and invoices helps clients remember you and builds trust with new referrals.' },
