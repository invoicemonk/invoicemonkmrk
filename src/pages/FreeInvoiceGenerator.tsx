        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground space-y-4">
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li>✓ Your tax registration number (if applicable)</li>
            </ul>
            <p>Missing any of these can delay payment or cause compliance issues. Our free generator includes fields for all of them.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 lg:py-24 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <h3 className="font-semibold text-foreground flex items-center gap-2"><Shield className="w-4 h-4 text-primary" /> Tax-Ready</h3>
              <p className="text-sm text-muted-foreground">Built-in tax calculation ensures your invoices meet basic compliance requirements. Add your tax registration number for full compliance.</p>
            </div>
            <div className="space-y-2">
