...
const faqs = [
  ...
  { question: 'Is there a free plan for small e-commerce sellers?', answer: 'Yes! Start free with unlimited invoices. The free tier is perfect for sellers just starting their B2B or wholesale operations. Upgrade as your business grows and you need features like recurring billing, advanced reporting, and multi-currency support.' },
