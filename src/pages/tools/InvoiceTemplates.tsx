...
import { ArrowRight, Download, FileText, CheckCircle, Star, Users, Globe } from 'lucide-react';
    ...
    <Layout>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-b from-muted/50 to-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
            Choose from 6 professionally designed invoice templates. Customize with your logo and details, then download as PDF — all in under 2 minutes.
          </p>
            ...
            {templates.map((tmpl) => (
              <Card key={tmpl.id} className="overflow-hidden border border-border hover:shadow-lg transition-shadow group">
                <div className="relative aspect-[16/10] overflow-hidden bg-muted">
                  <img
                    src={tmpl.image}
                    alt={`${tmpl.name} invoice template preview`}
      ...
      <section className="py-16 lg:py-24 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <h2 className="text-2xl font-bold text-foreground text-center mb-12">How to Create an Invoice in 3 Steps</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: '1', title: 'Choose a Template', desc: 'Pick the template that matches your industry and style. All templates are professional and tax-compliant.' },
              { step: '2', title: 'Add Your Details', desc: 'Fill in your business info, client details, line items, tax rates, and payment terms. Upload your logo.' },
              { step: '3', title: 'Download PDF', desc: 'Generate a professional PDF invoice instantly. Email it to your client or print a copy for your records.' },
            ].map((item) => (
