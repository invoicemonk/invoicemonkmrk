...
const benefitIcons = [Sparkles, Clock, Palette, Shield];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {testimonials.map((tm, i) => (
              <Card key={i} className="border-border/50"><CardContent className="p-8"><p className="text-foreground mb-6 italic">"{tm.quote}"</p><div><p className="font-semibold text-foreground">{tm.author}</p><p className="text-sm text-muted-foreground">{tm.role}</p></div></CardContent></Card>
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/blog/how-to-become-a-good-graphic-designer" className="text-primary hover:underline">{t('relatedLinks.graphicDesigner')}</Link>
            <Link to="/blog/pricing-your-freelance-services" className="text-primary hover:underline">{t('relatedLinks.pricing')}</Link>
            <Link to="/blog/freelance-portfolio-best-practices" className="text-primary hover:underline">{t('relatedLinks.portfolio')}</Link>
          </div>
        </div>
      </section>
