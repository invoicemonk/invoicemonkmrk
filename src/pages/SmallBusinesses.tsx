...
const SmallBusinesses = () => {
  const { t } = useTranslation('smallBusinesses');
  ...
  const heroStats = t('hero.stats', { returnObjects: true }) as StatItem[];
  const statsItems = t('stats.items', { returnObjects: true }) as StatItem[];
  ...
  return (
    <Layout>
      ...
      <div className="relative">
        <PageHero
          badge={{ icon: Building2, text: t('hero.badge') }}
          title={t('hero.title')}
      ...
      <section className="py-16 lg:py-24 bg-primary">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button size="lg" className="bg-white hover:bg-white/90 text-black" asChild>
            <a href="https://app.invoicemonk.com/signup?plan=professional" target="_blank" rel="noopener noreferrer">{t('cta.button')}<ArrowRight className="ml-2 w-4 h-4" /></a>
          </Button>
        </div>
      </section>
    </Layout>
