...
export const eInvoicingClusterPostsBatch2: BlogPost[] = [
  ...
  // ============================================================
  {
    ...
    content: `<p><strong>To comply with Peppol in the EU, register through a certified Peppol Access Point, obtain a Peppol Participant Identifier in the SMP/SML directory, emit invoices in Peppol BIS Billing 3.0 (UBL 2.1 customisation of EN 16931), pass the official Schematron validation, and exchange documents AP-to-AP over AS4 with signed receipts. Belgium has mandated this for B2B since 1 January 2026; Germany requires B2B receipt since 1 January 2025; France switches on receipt for all businesses on 1 September 2026.</strong></p><div class="fact-box">
      ...
      </ul><h2>Related reading</h2><p class="block-answer" data-answer="true">Start at the e-invoicing pillar, then the Peppol EU mandate page.  For background, read Peppol EU explained: scope, country mandates, and what changes in 2026.</p><p>Start at the <a href="/en/e-invoicing">e-invoicing pillar</a>, then the <a href="/en/e-invoicing/peppol-eu">Peppol EU mandate page</a>. For background, read <a href="/en/blog/peppol-eu-explained">Peppol EU explained: scope, country mandates, and what changes in 2026</a>. To compare to clearance regimes, read <a href="/en/blog/peppol-vs-national-portals">Peppol vs national portals</a>. For deep dives on the building blocks: <a href="/en/blog/what-is-peppol-access-point">what is a Peppol Access Point</a>, <a href="/en/blog/ubl-2-1-explained">UBL 2.1 explained</a>, and <a href="/en/blog/xades-digital-signatures-explained">XAdES digital signatures</a>.</p><h2 id="sources">Sources</h2><ul>
  ...
  // ============================================================
  {
    ...
    content: `<p><strong>Peppol is the EU-governed network for exchanging structured business documents — most prominently invoices — between trading partners across borders. It runs on a four-corner model where senders and receivers transact through certified Access Points over AS4, using Peppol BIS Billing 3.0 (a UBL 2.1 customisation of EN 16931). It is mandatory for B2G across the EU under Directive 2014/55/EU, and now for B2B in Belgium (2026), Germany (phased 2025–2028), and France (phased 2026–2027). The VAT in the Digital Age (ViDA) package, adopted on 11 March 2025, rolls digital reporting requirements out to January 2035.</strong></p><div class="fact-box">
      ...
      </ul><p>Critically, ViDA removed the derogation requirement: since 14 April 2025, member states can mandate e-invoicing for domestic transactions without prior Commission approval. That is the legal lever behind the cascade of national B2B mandates landing in 2025–2026.</p><h2 id="vs-clearance">How Peppol differs from clearance regimes</h2><p class="block-answer" data-answer="true">Peppol is a delivery network — it routes documents between trading partners.  It is not a tax authority clearance system.</p><p>Peppol is a delivery network — it routes documents between trading partners. It is not a tax authority clearance system. Regimes like <a href="/en/e-invoicing/zatca-phase-2">ZATCA Phase 2</a> or <a href="/en/e-invoicing/myinvois-malaysia">MyInvois</a> require the tax authority to approve or receive every invoice in near real time; Peppol does not. The two models are compared in <a href="/en/blog/peppol-vs-national-portals">Peppol vs national portals</a>.</p><h2 id="glossary">Peppol glossary — 8 terms you need</h2><p class="block-answer" data-answer="true">Peppol glossary — 8 terms you need includes: Access Point (AP): certified Peppol service provider that sends/receives documents on behalf of a participant.   SML: Service Metadata Locator — DNS-backed root directory of all SMPs on the network.</p><ul>
      ...
      </ul><h2>Related reading</h2><p class="block-answer" data-answer="true">Pillar: e-invoicing.  Sub-source: Peppol EU mandate page.</p><p>Pillar: <a href="/en/e-invoicing">e-invoicing</a>. Sub-source: <a href="/en/e-invoicing/peppol-eu">Peppol EU mandate page</a>. Siblings: <a href="/en/blog/how-to-comply-with-peppol-eu">how to comply with Peppol in the EU</a>, <a href="/en/blog/peppol-vs-national-portals">Peppol vs national portals</a>, <a href="/en/blog/what-is-peppol-access-point">what is a Peppol Access Point</a>, <a href="/en/blog/ubl-2-1-explained">UBL 2.1 explained</a>, <a href="/en/blog/xades-digital-signatures-explained">XAdES digital signatures</a>.</p><h2 id="sources">Sources</h2><ul>
  ...
  // ============================================================
  {
    ...
    content: `<p><strong>Peppol is a four-corner delivery network: senders and receivers exchange invoices via certified Access Points over AS4, with the tax authority outside the path. Clearance portals (Saudi Arabia's ZATCA Phase 2, Malaysia's MyInvois, India's GST IRN, Italy's SDI, Poland's KSeF) put the tax authority inside the path — every invoice must be approved, validated, or registered by the regulator before or as it is delivered. Multinationals typically run both models in parallel and need a single platform that speaks both.</strong></p><div class="fact-box">
      ...
      </ul><h2 id="standard">Document standard</h2><p class="block-answer" data-answer="true">Document standard — Peppol: UBL 2.  1 — Peppol BIS Billing 3.</p><table>
      ...
      </ul><h2>Related reading</h2><p class="block-answer" data-answer="true">Pillar: e-invoicing.  Mandate pages: Peppol EU, ZATCA Phase 2, MyInvois Malaysia, GST IRN India.</p><p>Pillar: <a href="/en/e-invoicing">e-invoicing</a>. Mandate pages: <a href="/en/e-invoicing/peppol-eu">Peppol EU</a>, <a href="/en/e-invoicing/zatca-phase-2">ZATCA Phase 2</a>, <a href="/en/e-invoicing/myinvois-malaysia">MyInvois Malaysia</a>, <a href="/en/e-invoicing/gst-irn-india">GST IRN India</a>. Siblings: <a href="/en/blog/peppol-eu-explained">Peppol EU explained</a>, <a href="/en/blog/how-to-comply-with-peppol-eu">how to comply with Peppol in the EU</a>, <a href="/en/blog/what-is-peppol-access-point">what is a Peppol Access Point</a>.</p><h2 id="sources">Sources</h2><ul>
  ...
  // ============================================================
  {
    ...
    content: `<p><strong>A Peppol Access Point (AP) is a certified service provider that sends and receives structured business documents on the Peppol network on behalf of a participant. APs sit at corners 2 and 3 of the four-corner model: they resolve the receiver's endpoint via the Peppol SML/SMP, transmit documents over AS4 with signed non-repudiation receipts, and validate against Peppol BIS Schematron. You almost never run your own AP — you use the one operated by your invoicing platform.</strong></p><div class="fact-box">
      ...
      </ul><h2>Related reading</h2><p class="block-answer" data-answer="true">Pillar: e-invoicing.  Mandate: Peppol EU.</p><p>Pillar: <a href="/en/e-invoicing">e-invoicing</a>. Mandate: <a href="/en/e-invoicing/peppol-eu">Peppol EU</a>. Siblings: <a href="/en/blog/peppol-eu-explained">Peppol EU explained</a>, <a href="/en/blog/how-to-comply-with-peppol-eu">how to comply with Peppol in the EU</a>, <a href="/en/blog/peppol-vs-national-portals">Peppol vs national portals</a>, <a href="/en/blog/ubl-2-1-explained">UBL 2.1 explained</a>.</p><h2 id="certified">What "certified access point" means</h2><p class="block-answer" data-answer="true">A certified Peppol access point is a provider that has passed OpenPeppol conformance and security testing, signed the Peppol Transport Infrastructure Agreement with a national Peppol Authority, and holds a valid Peppol PKI certificate. Certification is renewed annually, so a provider listed as certified two years ago may not be certified today.</p><p>Check any provider against the <a href="https://peppol.org/members/" rel="noopener noreferrer">OpenPeppol member directory</a> before you sign, and confirm it is covered by the Peppol Authority for the country you invoice into.</p><h2 id="countries">Access points by country</h2><p class="block-answer" data-answer="true">Requirements differ by Peppol Authority.  Country guides: Belgium access points, Belgium mandate, Bulgaria, Nigeria (FIRS) — plus every deadline in the e-invoicing mandate tracker.</p><p>Requirements differ by Peppol Authority. Country guides: <a href="/en/blog/belgium-peppol-access-point-guide">Belgium access points</a>, <a href="/en/blog/belgium-e-invoicing-peppol-mandate-guide">Belgium mandate</a>, <a href="/en/blog/bulgaria-e-invoicing-xml-peppol-format">Bulgaria</a>, <a href="/en/blog/nigeria-peppol-firs">Nigeria (FIRS)</a> — plus every deadline in the <a href="/en/e-invoicing">e-invoicing mandate tracker</a>.</p><h2 id="sources">Sources</h2><ul>
        <li><a href="https://docs.peppol.eu/edelivery/as4/specification/" rel="noopener noreferrer">OpenPeppol — Peppol AS4 Profile v2.0.3</a></li>
  ...
  // ============================================================
  {
    ...
    content: `<p><strong>UBL 2.1 (Universal Business Language version 2.1) is the OASIS XML standard for representing 65 business document types — orders, despatch advices, invoices, credit notes, catalogues, statements. It was ratified as an OASIS Standard on 4 November 2013 and is the canonical XML syntax for EN 16931 in Europe, the base format for Peppol BIS Billing 3.0, ZATCA Phase 2 KSA, MyInvois Malaysia, and several other regimes. Every regulator that picked UBL 2.1 did so because it is open, royalty-free, schema-validated, and supports jurisdiction-specific extensions without breaking interoperability.</strong></p><div class="fact-box">
      ...
      </ul><h2>Related reading</h2><p class="block-answer" data-answer="true">Pillar: e-invoicing.  Siblings: XAdES digital signatures explained, what is a Peppol Access Point, Peppol EU explained.</p><p>Pillar: <a href="/en/e-invoicing">e-invoicing</a>. Siblings: <a href="/en/blog/xades-digital-signatures-explained">XAdES digital signatures explained</a>, <a href="/en/blog/what-is-peppol-access-point">what is a Peppol Access Point</a>, <a href="/en/blog/peppol-eu-explained">Peppol EU explained</a>.</p><h2 id="sources">Sources</h2><ul>
  ...
  // ============================================================
  {
    ...
    content: `<p><strong>XAdES (XML Advanced Electronic Signatures) is the ETSI standard — EN 319 132-1 — that extends the XML Digital Signature (XML-DSig) specification with the additional properties needed for long-term legal validity. It defines four baseline levels — B-B, B-T, B-LT, B-LTA — that progressively add timestamps, validation material, and archive timestamps. ZATCA Phase 2 uses XAdES-B-B-Sig with the CSID; Peppol signs the AS4 envelope and optionally the UBL payload; many EU qualified e-signature flows use XAdES-B-LT or B-LTA for 10-year retention.</strong></p><div class="fact-box">
      ...
      </ul><h2>Related reading</h2><p class="block-answer" data-answer="true">Pillar: e-invoicing.  Siblings: UBL 2.</p><p>Pillar: <a href="/en/e-invoicing">e-invoicing</a>. Siblings: <a href="/en/blog/ubl-2-1-explained">UBL 2.1 explained</a>, <a href="/en/blog/what-is-peppol-access-point">what is a Peppol Access Point</a>, <a href="/en/blog/peppol-eu-explained">Peppol EU explained</a>. Mandate context: <a href="/en/e-invoicing/zatca-phase-2">ZATCA Phase 2</a>.</p><h2 id="sources">Sources</h2><ul>
