...
export const homepageFAQs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Invoicemonk has a permanent Free plan at $0/month (3 invoices per month, 1 user, unlimited clients). The Pro plan is $15/month with unlimited invoices, client management, expense tracking, and full audit trail. SME at $49/month adds online payments and advanced reports; Biz is custom-priced with e-invoicing, dedicated support, and SLA. You can cancel anytime.",
  },
  {
