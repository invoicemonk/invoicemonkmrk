...
<h2>Step 4: Itemize Your Services or Products</h2><p class="block-answer" data-answer="true">The line items table is the heart of your invoice.</p><p>The line items table is the heart of your invoice. Each row should include:</p><table>
  ...
  // P3-G-03 — Invoice vs Receipt
  {
    ...
    faq: [
      ...
      { question: 'Can one document serve as both an invoice and a receipt?', answer: 'Yes, in many jurisdictions a single document can work as both if it is issued before payment as an invoice and later stamped or updated with a "PAID" status, payment date, and payment method.' },
      { question: 'What happens if I only issue receipts and never invoices?', answer: 'For B2B sales this creates a compliance gap: business clients generally need a formal invoice with a tax ID and itemized breakdown to claim the expense or Input Tax Credit. Receipts alone are usually acceptable only for cash, point-of-sale, or B2C transactions.' },
      { question: 'Do freelancers need to issue receipts as well as invoices?', answer: 'Most freelancers only need to issue invoices and can mark them "PAID" once settled instead of generating a separate receipt. A standalone receipt becomes useful when a client specifically requests one for their own expense reporting or when payment is made in cash.' },
    ],
...
</ul><h2>Which Document Should You Issue? Best-For Summary</h2><p class="block-answer" data-answer="true">Use an invoice when you are requesting payment for B2B work, credit sales, or recurring billing. Use a receipt when confirming a payment already received, especially for cash or B2C point-of-sale transactions.</p><table>
  <thead><tr><th>Scenario</th><th>Document</th><th>Best for</th></tr></thead>
  <tbody>
    <tr><td>Billing a client after finishing a project</td><td>Invoice</td><td>Freelancers and consultants requesting payment</td></tr>
    <tr><td>Customer pays immediately at a shop or checkout</td><td>Receipt</td><td>Retail and point-of-sale businesses</td></tr>
    <tr><td>Confirming a bank transfer landed</td><td>Receipt (or invoice marked "PAID")</td><td>Any business closing out an invoice</td></tr>
