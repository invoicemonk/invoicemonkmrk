...
export const cluster11Posts: BlogPost[] = [
  ...
  // P1-IN-01 — Country Hub
  {
    ...
    content: `
<p><strong>India's GST e-invoicing system is transforming how businesses issue invoices.</strong> Since its phased rollout beginning October 2020, the Goods and Services Tax Network (GSTN) has mandated electronic invoicing for an ever-expanding number of businesses. If you're a small business owner or freelancer in India, understanding e-invoicing is critical — the threshold is dropping, and enforcement is tightening.</p>

<p>According to GSTN data, <strong>over 800 million e-invoices were generated in 2025</strong>, and the government continues pushing toward universal adoption. This guide covers everything: what GST e-invoicing is, who must comply, IRN generation, penalties, and how to get your invoicing system ready.</p>
...
<h2>Who Must Comply? The Threshold Timeline</h2>
...
<h2>How the IRP Process Works</h2>
...
<h2>Mandatory Fields for GST E-Invoices</h2>
...
<h2>E-Invoicing for Different Business Types</h2>
...
<h2>How Invoicemonk Helps with GST E-Invoicing</h2>
