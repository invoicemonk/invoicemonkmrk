...
const countries: CC[] = [
  ...
  { code: 'ro', name: 'Romania', nameEs: 'Rumanía', demonym: 'Romanian', demonymEs: 'rumano',
    authority: 'ANAF', authorityFull: 'Agenția Națională de Administrare Fiscală', taxType: 'IVA', taxRate: '19 % (estándar), 9 %, 5 %',
    currency: 'RON', currencyCode: 'RON', taxId: 'CUI/CIF', taxIdFull: 'Cod Unic de Înregistrare',
    vatThreshold: 'RON 300.000 de facturación anual', filingFrequencyEs: 'mensualmente, antes del 25 del mes siguiente',
    recordKeepingYears: '10', paymentMethodsEs: 'transferencia bancaria, tarjetas y PayU Romania',
    penaltiesEs: 'Intereses de demora: 0,06 %/día. No registro: RON 1.000–5.000.',
    einvoicingContextEs: 'Rumanía ha implementado la e-Factura obligatoria para todas las transacciones B2B vía ANAF.',
    registrationUrl: 'https://www.anaf.ro' },
  { code: 'hu', name: 'Hungary', nameEs: 'Hungría', demonym: 'Hungarian', demonymEs: 'húngaro',
    authority: 'NAV', authorityFull: 'Nemzeti Adó- és Vámhivatal', taxType: 'IVA (ÁFA)', taxRate: '27 % (estándar), 18 %, 5 %',
    currency: 'HUF', currencyCode: 'HUF', taxId: 'Adószám', taxIdFull: 'Adószám (Número fiscal)',
    vatThreshold: 'HUF 12 M de facturación anual', filingFrequencyEs: 'mensualmente (facturación >HUF 50 M), trimestralmente o anualmente',
    recordKeepingYears: '8', paymentMethodsEs: 'transferencia bancaria, Barion, SimplePay y tarjetas',
    penaltiesEs: 'Hasta 50 % del déficit fiscal. HUF 500.000 por infracciones de declaración.',
    einvoicingContextEs: 'Hungría opera el sistema obligatorio Online Számla de reporte en tiempo real. Toda factura >HUF 100.000 de IVA debe reportarse a NAV en tiempo real.',
    registrationUrl: 'https://nav.gov.hu' },
  { code: 'rs', name: 'Serbia', nameEs: 'Serbia', demonym: 'Serbian', demonymEs: 'serbio',
    authority: 'SEF', authorityFull: 'Sistem Elektronskih Faktura', taxType: 'IVA (PDV)', taxRate: '20 % (estándar), 10 %',
    currency: 'RSD', currencyCode: 'RSD', taxId: 'PIB', taxIdFull: 'Poreski Identifikacioni Broj',
    vatThreshold: 'RSD 8 M de facturación anual', filingFrequencyEs: 'mensualmente, antes del 15 del mes siguiente',
    recordKeepingYears: '10', paymentMethodsEs: 'transferencia bancaria, IPS (pago instantáneo) y tarjetas',
    penaltiesEs: 'RSD 100.000–2.000.000 por incumplimiento de facturación electrónica.',
    einvoicingContextEs: 'Serbia ha hecho obligatoria la facturación electrónica SEF para todas las transacciones B2B y B2G.',
    registrationUrl: 'https://www.efaktura.gov.rs' },
  { code: 'pl', name: 'Poland', nameEs: 'Polonia', demonym: 'Polish', demonymEs: 'polaco',
    authority: 'KAS', authorityFull: 'Krajowa Administracja Skarbowa', taxType: 'IVA', taxRate: '23 % (estándar), 8 %, 5 %',
    currency: 'PLN', currencyCode: 'PLN', taxId: 'NIP', taxIdFull: 'Numer Identyfikacji Podatkowej',
    vatThreshold: 'PLN 200.000 de facturación anual', filingFrequencyEs: 'mensualmente, antes del 25 (JPK_VAT)',
    recordKeepingYears: '5', paymentMethodsEs: 'BLIK, transferencia bancaria, tarjetas, PayU y Przelewy24',
    penaltiesEs: 'Hasta 30 % de la discrepancia de IVA. Responsabilidad penal por fraude fiscal.',
    einvoicingContextEs: 'Polonia está implementando KSeF — un sistema obligatorio de facturación electrónica estructurada en formato XML.',
    registrationUrl: 'https://www.podatki.gov.pl' },
  { code: 'it', name: 'Italy', nameEs: 'Italia', demonym: 'Italian', demonymEs: 'italiano',
    authority: 'AdE', authorityFull: 'Agenzia delle Entrate', taxType: 'IVA', taxRate: '22 % (estándar), 10 %, 5 %, 4 %',
    currency: '€', currencyCode: 'EUR', taxId: 'Partita IVA', taxIdFull: 'Partita IVA (N.º IVA)',
    vatThreshold: '€65.000 de facturación anual (régimen forfetario)', filingFrequencyEs: 'mensual o trimestralmente; declaración anual antes del 30 de abril',
    recordKeepingYears: '10', paymentMethodsEs: 'transferencia (bonifico), PagoPA, tarjetas y Satispay',
    penaltiesEs: '120–240 % del IVA impagado. €250–€2.000 por facturas ausentes.',
    einvoicingContextEs: 'Italia opera el sistema obligatorio FatturaPA/SDI — todas las facturas deben pasar por el sistema de intercambio gubernamental. Primer país de la UE en imponer facturación electrónica B2B.',
    registrationUrl: 'https://www.agenziaentrate.gov.it' },
  { code: 'bg', name: 'Bulgaria', nameEs: 'Bulgaria', demonym: 'Bulgarian', demonymEs: 'búlgaro',
    authority: 'NRA', authorityFull: 'National Revenue Agency', taxType: 'IVA (ДДС)', taxRate: '20 % (estándar), 9 %',
    currency: 'BGN', currencyCode: 'BGN', taxId: 'ЕИК/БУЛСТАТ', taxIdFull: 'ЕИК/БУЛСТАТ (EIK/BULSTAT)',
    vatThreshold: 'BGN 100.000 de facturación imponible anual', filingFrequencyEs: 'mensualmente, antes del 14 del mes siguiente',
    recordKeepingYears: '5', paymentMethodsEs: 'transferencia bancaria, ePay.bg y tarjetas',
    penaltiesEs: 'BGN 500–10.000 por no registro. Intereses de demora: 0,03 %/día. Numeración secuencial de 10 dígitos obligatoria.',
    einvoicingContextEs: 'Bulgaria sigue la norma EN 16931 y exige archivos de auditoría SAF-T. La numeración de facturas debe seguir un formato secuencial estricto de 10 dígitos.',
...
function genTaxCompliant(c: CC): BlogPost {
  return {
    ...
    featuredImage: countriesWithImages.includes(c.code) ? `/images/blog/tax-compliant-invoice-${c.code}.jpg` : '/images/blog/invoicing-tax-compliance-hero.jpg', featuredImageAlt: `Guía factura conforme ${c.nameEs}`,
...
function genVatFormat(c: CC): BlogPost {
  return {
    ...
    featuredImage: countriesWithImages.includes(c.code) ? `/images/blog/vat-invoice-format-${c.code}.jpg` : '/images/blog/invoice-essential-elements.jpg', featuredImageAlt: `Formato factura ${c.taxType} ${c.nameEs}`,
    pillarContent: false, clusterType: 'cluster', targetProduct: '/compliance',
    ...
    content: `
      ...
      <p><a href="/invoicing">Generador de facturas gratuito</a> con todos los campos ${c.authority}.</p>
    `,
  };
}
...
function genFreelancerVat(c: CC): BlogPost {
  return {
    ...
    featuredImage: countriesWithImages.includes(c.code) ? `/images/blog/freelancer-vat-${c.code}.jpg` : '/images/blog/quarterly-tax-payments.jpg', featuredImageAlt: `Registro ${c.taxType} freelance ${c.nameEs}`,
    pillarContent: false, clusterType: 'cluster', targetProduct: '/compliance',
...
function genInvoiceAbroad(c: CC): BlogPost {
  return {
    ...
    featuredImage: countriesWithImages.includes(c.code) ? `/images/blog/invoice-abroad-${c.code}.jpg` : '/images/blog/multi-currency-invoicing.jpg', featuredImageAlt: `Facturar clientes ${c.demonymEs}s desde el extranjero`,
...
function genTaxMistakes(c: CC): BlogPost {
  return {
    ...
    featuredImage: countriesWithImages.includes(c.code) ? `/images/blog/tax-mistakes-${c.code}.jpg` : '/images/blog/tax-deductions.jpg', featuredImageAlt: `Errores fiscales freelances ${c.nameEs}`,
    pillarContent: false, clusterType: 'cluster', targetProduct: '/compliance',
