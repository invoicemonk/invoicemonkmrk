...
const countries: CountryConfig[] = [
  ...
  // ── New European Markets ──
  {
    ...
    taxType: 'VAT',
    taxRate: '19% (standard), 9% (reduced), 5% (super-reduced)',
    currency: 'RON',
    currencyCode: 'RON',
    taxId: 'CUI/CIF',
    taxIdFull: 'Cod Unic de Înregistrare',
    vatThreshold: 'RON 300,000 annual turnover',
    ...
    penalties: 'Late payment interest: 0.06%/day. Non-registration: RON 1,000–5,000. Late filing: RON 1,000–5,000 per return.',
    einvoicingContext: 'Romania has implemented mandatory e-Factura (e-Invoice) for all B2B transactions through ANAF. All invoices must be submitted electronically via the RO e-Factura system, making digital invoicing a legal requirement rather than an option.',
  ...
  },
  {
    ...
    taxType: 'VAT (ÁFA)',
    taxRate: '27% (standard), 18% (reduced), 5% (super-reduced)',
    currency: 'HUF',
    currencyCode: 'HUF',
    taxId: 'Adószám',
    taxIdFull: 'Adószám (Tax Number)',
    vatThreshold: 'HUF 12 million annual turnover',
    ...
    penalties: 'Up to 50% of tax shortfall. HUF 500,000 for reporting violations. Late payment interest at central bank base rate + surcharge.',
    einvoicingContext: 'Hungary operates the mandatory Online Számla (Online Invoice) real-time reporting system through NAV. Every invoice exceeding HUF 100,000 in VAT must be reported electronically to the tax authority in real time, making Hungary one of Europe\'s most digitally advanced tax systems.',
  ...
  },
  {
    ...
    demonym: 'Serbian',
    authority: 'SEF',
    authorityFull: 'Sistem Elektronskih Faktura',
    taxType: 'VAT (PDV)',
    taxRate: '20% (standard), 10% (reduced)',
    currency: 'RSD',
    currencyCode: 'RSD',
    taxId: 'PIB',
    taxIdFull: 'Poreski Identifikacioni Broj',
    vatThreshold: 'RSD 8 million annual turnover',
    ...
    penalties: 'RSD 100,000–2,000,000 for non-compliance with e-invoicing. Late filing penalties based on tax shortfall amount.',
    einvoicingContext: 'Serbia has implemented mandatory SEF (Sistem Elektronskih Faktura) e-invoicing for all B2B and B2G transactions. All businesses must issue, receive, and store invoices through the central government electronic invoicing platform.',
  ...
  },
  {
    ...
    taxType: 'VAT',
    taxRate: '23% (standard), 8% (reduced), 5% (super-reduced)',
    currency: 'PLN',
    currencyCode: 'PLN',
    taxId: 'NIP',
    taxIdFull: 'Numer Identyfikacji Podatkowej',
    vatThreshold: 'PLN 200,000 annual turnover',
    filingFrequency: 'monthly, by the 25th (JPK_VAT combined return)',
    recordKeepingYears: '5',
    paymentMethods: 'BLIK, bank transfer, card payments, PayU, and Przelewy24',
    penalties: 'Up to 30% of VAT discrepancy. Criminal liability for tax fraud. Late payment interest at 200% of Lombard rate.',
    einvoicingContext: 'Poland is implementing KSeF (Krajowy System e-Faktur — National e-Invoice System), which mandates structured e-invoicing for all VAT-registered businesses. The system requires invoices to be issued in a standardised XML format through the central government platform.',
  ...
  },
  {
    ...
    taxType: 'IVA',
    taxRate: '22% (standard), 10% (reduced), 5% (super-reduced), 4% (minimum)',
    currency: '€',
    currencyCode: 'EUR',
    taxId: 'Partita IVA',
    taxIdFull: 'Partita IVA (VAT Number)',
    vatThreshold: '€65,000 annual revenue (regime forfettario)',
    filingFrequency: 'monthly or quarterly; annual declaration by April 30th',
    recordKeepingYears: '10',
    paymentMethods: 'bank transfer (bonifico), PagoPA, card payments, and Satispay',
    penalties: '120%–240% of underpaid IVA. €250–€2,000 for missing invoices. Late payment interest at legal rate + surcharge.',
    einvoicingContext: 'Italy operates mandatory FatturaPA/SDI (Sistema di Interscambio) — all invoices must pass through the government exchange system. Italy was the first EU country to mandate B2B e-invoicing and serves as a model for other European implementations.',
  ...
  },
  {
    ...
    demonym: 'Bulgarian',
    authority: 'NRA',
    authorityFull: 'National Revenue Agency (Национална агенция за приходите)',
    taxType: 'VAT (ДДС)',
    taxRate: '20% (standard), 9% (reduced for tourism/restaurants)',
    currency: 'BGN',
    currencyCode: 'BGN',
    taxId: 'ЕИК/БУЛСТАТ',
    taxIdFull: 'ЕИК/БУЛСТАТ (EIK/BULSTAT)',
    vatThreshold: 'BGN 100,000 annual taxable turnover',
    filingFrequency: 'monthly, by the 14th of the following month',
    recordKeepingYears: '5',
    paymentMethods: 'bank transfer, ePay.bg, and card payments',
    penalties: 'BGN 500–10,000 for non-registration. Late payment interest: 0.03%/day. Strict 10-digit sequential invoice numbering enforced.',
    einvoicingContext: 'Bulgaria follows the EN 16931 European e-invoicing standard and requires SAF-T (Standard Audit File for Tax) audit file submissions. Invoice numbering must follow strict 10-digit sequential formatting, and businesses must be prepared for NRA audits with compliant digital records.',
    registrationUrl: 'https://www.nra.bg',
  },
  // ── New Markets: Middle East & Asia-Pacific ──
  {
    code: 'sa',
    name: 'Saudi Arabia',
    demonym: 'Saudi',
    authority: 'ZATCA',
    authorityFull: 'Zakat, Tax and Customs Authority',
    taxType: 'VAT',
    taxRate: '15%',
    currency: 'SAR',
    currencyCode: 'SAR',
    taxId: 'TIN',
    taxIdFull: 'Tax Identification Number (الرقم الضريبي)',
    vatThreshold: 'SAR 375,000 annual taxable supplies (voluntary from SAR 187,500)',
    filingFrequency: 'monthly (if turnover >SAR 40M), otherwise quarterly',
    recordKeepingYears: '6',
    paymentMethods: 'bank transfer (SADAD), mada cards, Apple Pay, STC Pay, and credit cards',
    penalties: 'Non-compliance with e-invoicing: SAR 5,000–50,000. Late filing: 5%–25% of unpaid VAT. Late registration: SAR 10,000. Incorrect invoices: warning then SAR 1,000+ per invoice.',
    einvoicingContext: 'Saudi Arabia mandates FATOORAH e-invoicing through ZATCA. Phase 1 (Generation) has been mandatory since December 2021 for all VAT-registered businesses. Phase 2 (Integration) requires real-time reporting to ZATCA via API, rolling out in waves based on revenue thresholds. E-invoices must include QR codes, XML format, and cryptographic stamps.',
    registrationUrl: 'https://zatca.gov.sa',
  },
  {
    code: 'my',
    name: 'Malaysia',
    demonym: 'Malaysian',
    authority: 'LHDN',
    authorityFull: 'Lembaga Hasil Dalam Negeri (Inland Revenue Board)',
    taxType: 'SST',
    taxRate: '6% (service tax), 10% (sales tax)',
    currency: 'RM',
    currencyCode: 'MYR',
    taxId: 'TIN',
    taxIdFull: 'Tax Identification Number (Nombor Cukai)',
    vatThreshold: 'RM 500,000 annual taxable turnover (for SST)',
    filingFrequency: 'bi-monthly for SST; annual for income tax',
    recordKeepingYears: '7',
    paymentMethods: 'FPX (online banking), DuitNow, credit/debit cards, and Touch \'n Go eWallet',
    penalties: 'Non-compliance with e-invoicing: RM 200–20,000 or imprisonment up to 6 months. Late SST filing: RM 30–RM 60/day. Late income tax: 10% penalty on unpaid tax.',
    einvoicingContext: 'Malaysia is implementing MyInvois, a mandatory e-invoicing system managed by LHDN. Phase 1 (August 2024) applies to businesses with annual turnover exceeding RM 100 million. Full rollout to all businesses is scheduled for July 2025. E-invoices must be validated in real-time through the MyInvois portal or API before being shared with buyers.',
    registrationUrl: 'https://www.hasil.gov.my',
  },
  {
    code: 'fr',
    name: 'France',
    ...
    taxType: 'TVA',
    taxRate: '20% standard, 10% intermediate, 5.5% reduced, 2.1% super-reduced',
    currency: '€',
    currencyCode: 'EUR',
    taxId: 'SIREN/SIRET',
    taxIdFull: 'Numéro SIREN/SIRET',
    vatThreshold: '€85,800 (goods) / €34,400 (services) for franchise en base de TVA',
    filingFrequency: 'monthly (régime réel normal) or quarterly (régime simplifié)',
    recordKeepingYears: '10',
    paymentMethods: 'SEPA transfers, carte bancaire, cheques, LCR/BOR bills of exchange',
    penalties: 'Non-compliance with e-invoicing: €15 per invoice (capped at €15,000/year). Late TVA filing: 10% surcharge + 0.2%/month interest. Missing TVA registration: up to 80% of owed TVA.',
    einvoicingContext: 'France is implementing mandatory e-invoicing via the PPF (Portail Public de Facturation) and accredited PDP (Plateformes de Dématérialisation Partenaires). Large enterprises must comply from September 2026, mid-sized from September 2027, and SMEs/micro from September 2028. B2B e-invoicing uses Factur-X (hybrid PDF/XML based on CII) and UBL formats.',
    registrationUrl: 'https://www.impots.gouv.fr',
  },
  {
    code: 'be',
    name: 'Belgium',
    ...
    taxType: 'TVA/BTW',
    taxRate: '21% standard, 12% reduced, 6% super-reduced',
    currency: '€',
    currencyCode: 'EUR',
    taxId: 'BCE/KBO',
    taxIdFull: 'Numéro d\'entreprise (Banque-Carrefour des Entreprises)',
    vatThreshold: '€25,000 annual turnover (small enterprise exemption)',
    filingFrequency: 'monthly or quarterly depending on turnover',
    recordKeepingYears: '7',
    paymentMethods: 'SEPA transfers, Bancontact, credit/debit cards',
    penalties: 'Non-compliance with e-invoicing: €50–€500 per invoice. Late TVA filing: €100 per declaration per month. Missing registration: 10% of owed TVA.',
    einvoicingContext: 'Belgium mandates structured e-invoicing for all B2B domestic transactions from January 1, 2026. The system uses PEPPOL BIS 3.0 (UBL format) through the Hermes/Mercurius platforms for B2G and the PEPPOL network for B2B. All VAT-registered businesses must be able to send and receive e-invoices.',
    registrationUrl: 'https://finances.belgium.be',
  },
  {
    code: 'br',
    name: 'Brazil',
    ...
    authorityFull: 'Receita Federal do Brasil (RFB)',
    taxType: 'ICMS/IPI/ISS',
    taxRate: 'ICMS 7-18% (interstate varies), IPI 0-330%, ISS 2-5%, PIS/COFINS 9.25%',
    currency: 'R$',
    currencyCode: 'BRL',
    taxId: 'CNPJ',
    taxIdFull: 'Cadastro Nacional da Pessoa Jurídica',
    vatThreshold: 'No threshold — all businesses must issue NF-e for goods, NFS-e for services',
    filingFrequency: 'monthly (SPED/EFD filing)',
    recordKeepingYears: '5',
    paymentMethods: 'PIX (instant), boleto bancário, TED/DOC bank transfers, credit/debit cards',
    penalties: 'Missing NF-e: 1% of transaction value (minimum R$500). Incorrect NF-e: 100% of tax difference. Late SPED filing: R$500–R$1,500/month.',
    einvoicingContext: 'Brazil pioneered e-invoicing in Latin America with NF-e (goods) mandatory since 2008 and NFS-e (services) since 2023 nationwide. The system requires real-time SEFAZ authorization before goods can ship. NF-e uses a specific XML schema and must include a digital certificate (e-CNPJ). Brazil is transitioning to the IBS/CBS tax reform (effective 2026-2033).',
    registrationUrl: 'https://www.gov.br/receitafederal',
  },
  {
    code: 'es',
    name: 'Spain',
    ...
    taxType: 'IVA',
    taxRate: '21% standard, 10% reduced, 4% super-reduced',
    currency: '€',
    currencyCode: 'EUR',
    taxId: 'NIF',
    taxIdFull: 'Número de Identificación Fiscal',
    vatThreshold: 'No general threshold — all businesses must charge IVA (freelancers under módulos may have simplified regime)',
    filingFrequency: 'quarterly (Modelo 303), annual summary (Modelo 390)',
    recordKeepingYears: '4',
    paymentMethods: 'SEPA transfers, Bizum, credit/debit cards, domiciliación bancaria',
    penalties: 'SII non-compliance: 0.5% of invoice amount (min €300, max €6,000/quarter). Late IVA filing: 5-20% surcharge. Missing registration: 150% of owed IVA.',
    einvoicingContext: 'Spain requires real-time VAT reporting through SII (Suministro Inmediato de Información) for large companies since 2017. A new B2B e-invoicing mandate under the Ley Crea y Crece requires all businesses to issue structured e-invoices from 2026 (large) and 2027 (SMEs). The system will use Facturae 3.2.2 format and integrate with the AEAT VeriFactu anti-fraud system.',
    registrationUrl: 'https://sede.agenciatributaria.gob.es',
  },
  {
    code: 'mx',
    name: 'Mexico',
    demonym: 'Mexican',
    authority: 'SAT',
    authorityFull: 'Servicio de Administración Tributaria',
    taxType: 'IVA',
    taxRate: '16% standard, 0% on food/medicine, exempt on education/health',
    currency: 'MX$',
    currencyCode: 'MXN',
    taxId: 'RFC',
    taxIdFull: 'Registro Federal de Contribuyentes',
    vatThreshold: 'No threshold — all registered taxpayers must issue CFDI',
    filingFrequency: 'monthly (declaración provisional)',
    recordKeepingYears: '5',
    paymentMethods: 'SPEI bank transfers, CoDi, credit/debit cards, cash (limited to MXN 2,000 for tax deductions)',
    penalties: 'Missing CFDI: MXN 17,020–97,330 per invoice. Incorrect CFDI: MXN 400–600 per error. Late filing: 1.47% monthly surcharge.',
    einvoicingContext: 'Mexico has required CFDI (Comprobante Fiscal Digital por Internet) since 2014 for all taxpayers. CFDI 4.0 is the current version (mandatory since 2023), requiring receiver RFC validation, fiscal regime codes, and usage codes. All CFDIs must be issued through SAT-authorized PAC (Proveedor Autorizado de Certificación) providers that stamp each invoice with a timbre fiscal digital.',
  ...
  },
  {
    ...
    demonym: 'Colombian',
    authority: 'DIAN',
    authorityFull: 'Dirección de Impuestos y Aduanas Nacionales',
    taxType: 'IVA',
    taxRate: '19% standard, 5% reduced, 0% on basics',
    currency: 'COP$',
    currencyCode: 'COP',
    taxId: 'NIT',
    taxIdFull: 'Número de Identificación Tributaria',
    vatThreshold: 'No threshold — all responsables del IVA must issue factura electrónica',
    filingFrequency: 'bi-monthly for IVA, annual income tax',
    recordKeepingYears: '5',
    paymentMethods: 'PSE (online banking), Nequi, Daviplata, credit/debit cards, Efecty (cash network)',
    penalties: 'Missing e-invoice: 1% of transaction value per day (max 100%). Incorrect e-invoice: 100% of tax difference. Late filing: 5% monthly surcharge.',
    einvoicingContext: 'Colombia mandated facturación electrónica for all IVA-responsible businesses through DIAN since 2019. The system requires real-time validation through DIAN before invoices are valid. Colombia also mandates documento soporte (for purchases from non-IVA payers) and nómina electrónica (electronic payroll). E-invoices use UBL 2.1 XML format.',
    registrationUrl: 'https://www.dian.gov.co',
  },
  {
    code: 'cl',
    name: 'Chile',
    demonym: 'Chilean',
    authority: 'SII',
    authorityFull: 'Servicio de Impuestos Internos',
    taxType: 'IVA',
    taxRate: '19%',
    currency: 'CLP$',
    currencyCode: 'CLP',
    taxId: 'RUT',
    taxIdFull: 'Rol Único Tributario',
    vatThreshold: 'No threshold — all taxpayers issuing invoices must use DTE',
    filingFrequency: 'monthly (Formulario 29 for IVA)',
    recordKeepingYears: '6',
    paymentMethods: 'Transferencia bancaria, WebPay, Khipu, MACH, credit/debit cards',
    penalties: '1-3 UTM per invoice (~CLP 65,000-195,000). Certificate suspension for repeat offenders. Late filing: 10% surcharge + 1.5%/month interest.',
    einvoicingContext: 'Chile fully mandated DTE (Documento Tributario Electrónico) e-invoicing since 2018 for all taxpayers. The system requires real-time SII authorization using XML format with digital certificates. Chile uses CAF (Código de Autorización de Folios) ranges pre-assigned by SII. Chile is one of Latin America\'s most mature e-invoicing markets.',
    registrationUrl: 'https://www.sii.cl',
  },
  {
    code: 'al',
    name: 'Albania',
    demonym: 'Albanian',
    authority: 'DPT',
    authorityFull: 'Drejtoria e Përgjithshme e Tatimeve (General Directorate of Taxation)',
    taxType: 'TVSH',
    taxRate: '20% standard, 6% reduced (tourism)',
    currency: 'ALL',
    currencyCode: 'ALL',
    taxId: 'NUIS',
    taxIdFull: 'Numri Unik i Identifikimit të Subjektit',
    vatThreshold: 'ALL 10,000,000 (~€85,000) annual turnover',
    filingFrequency: 'monthly for TVSH, annual for profit tax',
    recordKeepingYears: '5',
    paymentMethods: 'Bank transfers, credit/debit cards, mobile payments (limited adoption)',
    penalties: 'ALL 100,000–500,000 per violation (~€850–€4,250). Business closure for repeat offenders. Missing fiscalization: ALL 500,000 first offense.',
