...
function generateTaxCompliantInvoicePost(c: CountryConfig): BlogPost {
  return {
    ...
    featuredImage: `/blog/tax-compliant-invoice-${c.code}.jpg`,
...
function generateVatFormatPost(c: CountryConfig): BlogPost {
  return {
    ...
    dateModified: '2026-02-21',
    readTime: '9 min read',
    featuredImage: `/blog/vat-invoice-format-${c.code}.jpg`,
...
function generateRegulatorGuidePost(c: CountryConfig): BlogPost {
  ...
  return {
    ...
    featuredImage: `/blog/regulator-guide-${c.code}.jpg`,
...
function generateFreelancerVatPost(c: CountryConfig): BlogPost {
  return {
    ...
    dateModified: '2026-02-21',
    readTime: '8 min read',
    featuredImage: `/blog/freelancer-vat-${c.code}.jpg`,
...
function generateInvoiceFromAbroadPost(c: CountryConfig): BlogPost {
  return {
    ...
    dateModified: '2026-02-21',
    readTime: '9 min read',
    featuredImage: `/blog/invoice-abroad-${c.code}.jpg`,
...
function generateTaxMistakesPost(c: CountryConfig): BlogPost {
  return {
    ...
    dateModified: '2026-02-21',
    readTime: '8 min read',
    featuredImage: `/blog/tax-mistakes-${c.code}.jpg`,
...
const sharedPosts: BlogPost[] = [
  {
    ...
    dateModified: '2026-02-21',
    readTime: '7 min read',
    featuredImage: '/blog/revenue-vs-profit.jpg',
  ...
  },
  {
    ...
    dateModified: '2026-02-21',
    readTime: '9 min read',
    featuredImage: '/blog/track-business-expenses.jpg',
  ...
  },
  {
    ...
    dateModified: '2026-02-21',
    readTime: '10 min read',
    featuredImage: '/blog/multi-currency-invoicing.jpg',
