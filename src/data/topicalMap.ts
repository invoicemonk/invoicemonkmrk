...
export const pillarClusters: TopicalCluster[] = [
  ...
  },
  {
    ...
    postSlugs: [
      ...
      // Cluster 17: E-Invoicing Compliance P1 (France, Belgium, Italy, Brazil, Spain)
      'france-e-invoicing-ppf-pdp-guide', 'france-ppf-vs-pdp-e-invoicing-platforms',
      'france-e-reporting-vs-e-invoicing', 'france-factur-x-e-invoice-format-guide',
      'france-e-invoicing-penalties-compliance', 'france-e-invoicing-registration-small-business',
      'france-e-invoicing-foreign-companies',
      'belgium-e-invoicing-peppol-mandate-guide', 'belgium-peppol-technical-requirements',
      'belgium-e-invoicing-b2g-mercurius', 'belgium-e-invoicing-penalties-vat-compliance',
      'belgium-peppol-access-point-guide', 'belgium-e-invoicing-tax-deduction',
      'belgium-e-invoicing-small-business',
      'italy-e-invoicing-sdi-guide', 'italy-fatturapa-xml-format-guide',
      'italy-sdi-cross-border-e-invoicing', 'italy-e-invoicing-penalties-compliance',
      'italy-e-invoicing-regime-forfettario', 'italy-e-invoicing-foreign-companies',
      'brazil-e-invoicing-nfe-nfse-guide', 'brazil-nfe-xml-technical-requirements',
      'brazil-nfse-nacional-services-invoicing', 'brazil-nfce-consumer-electronic-invoice',
      'brazil-e-invoicing-digital-certificate', 'brazil-tax-reform-e-invoicing-impact',
      'brazil-e-invoicing-penalties-compliance', 'brazil-e-invoicing-foreign-companies',
      'spain-e-invoicing-verifactu-sii-guide', 'spain-verifactu-invoicing-software-requirements',
      'spain-sii-real-time-vat-reporting', 'spain-ticketbai-basque-country-invoicing',
      'spain-face-b2g-electronic-invoicing', 'spain-e-invoicing-penalties-compliance',
      'spain-e-invoicing-foreign-companies',
      // Cluster 18: E-Invoicing Compliance P2 (Poland, Mexico, Colombia, Romania, Hungary)
      'poland-e-invoicing-ksef-guide', 'poland-ksef-fa2-xml-schema-guide',
      'poland-ksef-registration-setup-guide', 'poland-ksef-penalties-compliance',
      'poland-ksef-small-business-guide', 'poland-ksef-foreign-companies',
      'mexico-e-invoicing-cfdi-guide', 'mexico-cfdi-40-xml-requirements',
      'mexico-pac-provider-guide', 'mexico-cfdi-complemento-pago-guide',
      'mexico-cfdi-cancellation-rules', 'mexico-e-invoicing-penalties-compliance',
      'mexico-e-invoicing-foreign-companies',
      'colombia-e-invoicing-dian-guide', 'colombia-documento-soporte-guide',
      'colombia-nomina-electronica-guide', 'colombia-e-invoicing-nota-credito-debito',
      'colombia-e-invoicing-penalties-compliance', 'colombia-e-invoicing-foreign-companies',
      'romania-e-invoicing-anaf-guide', 'romania-cius-ro-xml-format-guide',
      'romania-e-transport-compliance-guide', 'romania-e-invoicing-penalties-compliance',
      'romania-e-invoicing-foreign-companies',
      'hungary-e-invoicing-nav-rtir-guide', 'hungary-nav-online-szamla-xml-guide',
      'hungary-nav-rtir-registration-setup', 'hungary-e-invoicing-penalties-compliance',
      'hungary-e-invoicing-foreign-companies',
      // Cluster 19: E-Invoicing Compliance P3 (Serbia, Bulgaria, Chile, Albania)
      'serbia-e-invoicing-sef-guide', 'serbia-sef-xml-ubl-format-guide',
      'serbia-sef-registration-setup-guide', 'serbia-e-invoicing-penalties-compliance',
      'serbia-e-invoicing-foreign-companies',
      'bulgaria-e-invoicing-nra-guide', 'bulgaria-e-invoicing-xml-peppol-format',
      'bulgaria-e-invoicing-registration-guide', 'bulgaria-e-invoicing-penalties-compliance',
      'bulgaria-e-invoicing-foreign-companies',
      'chile-e-invoicing-dte-sii-guide', 'chile-dte-xml-format-requirements',
      'chile-sii-registration-setup-guide', 'chile-e-invoicing-penalties-compliance',
      'chile-e-invoicing-foreign-companies',
      'albania-e-invoicing-fiskalizimi-guide', 'albania-fiskalizimi-xml-format-guide',
      'albania-e-invoicing-penalties-compliance', 'albania-e-invoicing-foreign-companies'
    ]
  },
  {
