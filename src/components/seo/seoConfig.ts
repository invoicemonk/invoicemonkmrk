...
export const pageSEO: Record<string, PageSEO> = {
  ...
  '/invoicing': {
    getTitle: (locale) => `Invoicing Software for Small Business | Free to Start | Invoicemonk`,
    getDescription: (locale) => `The easiest invoicing software for small businesses and freelancers in ${locale.content.seo.region}. Create professional invoices, automate reminders, and get paid faster. Free tier available.`,
    ogType: 'website',
    priority: 0.9,
    changefreq: 'weekly',
  },
  ...
  '/freelancers': {
    getTitle: (locale) => `Freelance Invoicing Software | Get Paid Faster | Free for Freelancers`,
    getDescription: (locale) => `The best freelance invoicing software in 2026. Create professional invoices, automate payment reminders, and track income in ${locale.content.seo.region} — free to start.`,
    ogType: 'website',
    priority: 0.8,
    changefreq: 'weekly',
  },
  ...
  '/free-invoice-generator': {
    getTitle: () => `Free Invoice Generator Online — Create & Download PDF | Invoicemonk`,
    getDescription: () => `Create professional invoices for free in under 2 minutes. No signup required. Download as PDF, add your logo, choose templates. Free invoice maker for freelancers and small businesses.`,
    ogType: 'website',
    priority: 0.9,
    changefreq: 'weekly',
  },
  ...
  '/international-payment-fee-calculator': {
    getTitle: () => 'International Payment Fee Calculator 2026 | Compare Wise vs PayPal vs Bank Transfer Fees',
    getDescription: () => 'Compare international payment fees across Wise, PayPal, SWIFT, and card processors. See exactly how much you\'ll receive after fees — free calculator, updated 2026.',
    ogType: 'website',
    priority: 0.8,
    changefreq: 'weekly',
  },
  '/paypal-vs-wise-fees': {
    getTitle: () => 'Wise vs PayPal: I Compared Fees on $500, $1K & $5K Transfers (2026)',
    getDescription: () => 'Real cost breakdowns: Wise vs PayPal fees on $500, $1,000 & $5,000 international transfers. See exactly how much you lose to hidden markups — with calculator.',
    ogType: 'website',
    priority: 0.8,
    changefreq: 'weekly',
  },
  '/cheapest-way-to-receive-international-payments': {
    ...
    getDescription: () => 'We ranked every method by total cost: Wise vs PayPal vs SWIFT vs card payments. Use our free calculator to find the cheapest option for your specific route.',
    ogType: 'website',
    priority: 0.8,
    changefreq: 'weekly',
  },
  ...
  '/best-invoicing-software': {
    getTitle: () => 'Best Invoicing Software 2026: I Tested 5 Platforms (Honest Review)',
    getDescription: () => 'I tested Invoicemonk, FreshBooks, Wave, Zoho & QuickBooks for 30 days each. Here\'s my honest comparison — features, pricing, pros, cons, and which I actually use.',
    ogType: 'website',
    priority: 0.8,
    changefreq: 'monthly',
  },
  '/use-cases/recurring-billing': {
    getTitle: () => 'Recurring Billing & Subscription Invoicing | Invoicemonk',
    getDescription: () => 'Automate recurring invoices for retainer clients, subscriptions, and repeat services. Set it up once and get paid on schedule.',
    ogType: 'website',
    priority: 0.7,
    changefreq: 'monthly',
  },
  '/use-cases/multi-currency-invoicing': {
    getTitle: () => 'Multi-Currency Invoicing Software | Invoice in Any Currency | Invoicemonk',
    getDescription: () => 'Send invoices in any currency. Multi-currency support for freelancers and businesses with international clients.',
    ogType: 'website',
    priority: 0.7,
    changefreq: 'monthly',
  },
