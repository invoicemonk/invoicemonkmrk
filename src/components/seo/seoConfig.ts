...
export const pageSEO: Record<string, PageSEO> = {
  ...
  '/paypal-vs-wise-fees': {
    getTitle: () => 'Wise vs PayPal Fees for International Transfers (2026) — Which Saves You More?',
    getDescription: () => 'Wise vs PayPal fees compared side by side for international invoice payments. Real cost breakdowns for $500, $1K, and $5K transfers. See who wins in 2026.',
    ogType: 'website',
    priority: 0.8,
    changefreq: 'weekly',
  },
  '/cheapest-way-to-receive-international-payments': {
    getTitle: () => 'Cheapest International Payment Methods for Invoices (2026) | Ranked by Total Cost',
    getDescription: () => 'Which is the cheapest way to settle international invoice payments? Wise vs PayPal vs SWIFT vs card — ranked by total cost with a real-time fee calculator. Updated February 2026.',
    ogType: 'website',
    priority: 0.8,
    changefreq: 'weekly',
  },
  ...
  '/best-invoicing-software': {
    getTitle: () => 'Best Invoicing Software for Small Business in 2026 | Top 5 Compared',
    getDescription: () => 'The best invoicing software for small business in 2026: Invoicemonk, FreshBooks, Wave, Zoho Invoice, and QuickBooks — features, pricing, pros, cons, and our honest pick.',
    ogType: 'website',
    priority: 0.8,
    changefreq: 'monthly',
  },
