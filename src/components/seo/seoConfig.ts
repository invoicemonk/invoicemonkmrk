...
export const pageSEO: Record<string, PageSEO> = {
  ...
  '/expenses': {
    getTitle: (locale) => `Expense Tracking Software for Small Business — Auto-Categorize & Save Hours | Invoicemonk`,
    getDescription: (locale) => `Track expenses, scan receipts, and categorize spending automatically. Stay ${locale.content.seo.complianceKeyword.toLowerCase()} and save 5+ hours/month on bookkeeping.`,
    ogType: 'website',
    priority: 0.8,
    changefreq: 'weekly',
  },
  ...
  '/free-invoice-generator': {
    getTitle: () => `Free Invoice Generator — Create & Download PDF in 2 Minutes | Invoicemonk`,
    getDescription: () => `Create professional invoices for free — no signup required. Add your logo, pick a template, and download as PDF in under 2 minutes. Used by 50,000+ freelancers and small businesses.`,
    ogType: 'website',
    priority: 0.9,
    changefreq: 'weekly',
  },
