...
export const pageSEO: Record<string, PageSEO> = {
  ...
  '/best-invoicing-software': {
    getTitle: () => 'Best Invoicing Software in 2026 | Top 5 Compared',
    getDescription: () => 'Compare the best invoicing software in 2026: Invoicemonk, FreshBooks, Wave, Zoho Invoice, and QuickBooks. Features, pricing, and recommendations.',
    ogType: 'website',
    priority: 0.8,
    changefreq: 'monthly',
  },
