...
const footerLinks = {
  ...
  resources: [
    ...
    { name: 'Video Tutorials', href: 'https://learn.invoicemonk.com', external: true },
      ...
      { name: 'Invoice Generator Australia', href: '/free-invoice-generator-australia' },
  ...
  compare: [
    ...
    { name: 'vs Dext', href: '/compare/invoicemonk-vs-dext' },
    { name: 'vs Stripe', href: '/compare/invoicemonk-vs-stripe' },
    { name: 'Estimates vs QuickBooks', href: '/compare/invoicemonk-estimates-vs-quickbooks' },
  ],
  company: [
...
const FooterLinkList = ({ links }: { links: { name: string; href: string; external?: boolean; badge?: string }[] }) => (
...
const FooterSection = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <div>
    <h4 className="text-body-sm font-semibold text-white mb-4">{title}</h4>
    {children}
  </div>
);
...
const SubSection = ({ label }: { label: string }) => (
  <li className="pt-2 border-t border-white/10 mt-3">
    <span className="text-body-sm font-medium text-white/40">{label}</span>
  </li>
);
...
export function Footer() {
  ...
  const footerLinks = {
    ...
    resources: [
      ...
      { name: t('footer.invoiceGeneratorAustralia', 'Invoice Generator Australia'), href: '/free-invoice-generator-australia' },
      { name: t('footer.invoiceGeneratorIndia', 'Invoice Generator India'), href: '/free-invoice-generator-india' },
    ...
    compare: [
      ...
      { name: t('footer.vsDext'), href: '/compare/invoicemonk-vs-dext' },
      { name: t('footer.vsStripe'), href: '/compare/invoicemonk-vs-stripe' },
      { name: t('footer.vsEstimatesQuickBooks'), href: '/compare/invoicemonk-estimates-vs-quickbooks' },
      { name: t('footer.vsAtoinvoice', 'vs Atoinvoice'), href: '/compare/invoicemonk-vs-atoinvoice' },
    ],
    company: [
  ...
  return (
    <footer className="bg-heading">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-8 lg:gap-10">
