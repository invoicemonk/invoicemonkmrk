...
const footerLinks = {
  ...
  compare: [
    ...
    { name: 'Best Receipt Scanner App', href: '/compare/best-receipt-scanner-app' },
    { name: 'Best for Freelancers', href: '/compare/best-invoicing-software-freelancers' },
...
export function Footer() {
  ...
  const footerLinks = {
    ...
    compare: [
      { name: t('footer.allComparisons', 'All comparisons'), href: '/compare' },
      { name: t('footer.bestInvoicingSoftware'), href: '/best-invoicing-software' },
      { name: t('footer.bestReceiptScanner', 'Best Receipt Scanner App'), href: '/compare/best-receipt-scanner-app' },
      { name: t('footer.bestForFreelancers', 'Best for Freelancers'), href: '/compare/best-invoicing-software-freelancers' },
